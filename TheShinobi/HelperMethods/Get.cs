    ...
    static class Get
    {
        ...
        public static string[] EndStory(Player player)
        {
            string[] stories = new string[]
            {
                ...
                "\t This is impossible... He is dead, you know you killed him and every last member of their Clan. \n" +
                ...
                "\t You are suddenly overwhelmed from behinde by enemies pulling you down towards the ground, \n" +
                "\t where did they come from!? \n" +
                "\t Kakuzu must have used his {ability} to block my senses! \n",
                ...
                "\t As you come to your senses you rush to Hanare and untie the ropes around her hands and neck \n" +
                ...
                "\t Tsunade meets you infront of Konoha Hospital and instantly brings Hanare in for care... \n " +
                ...
                "\t The peace is back in The Hidden Leaf Village \n\n " +
                "\t CREDITS: \n" +
                "\t Kakashi Hatake - Robin Kamo\n\n" +
                "\t Campus Mölndal Who made this possible\n\n" +
                "\t Every cool person who has shared music online\n\n" +
